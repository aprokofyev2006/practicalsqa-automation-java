@regression
@artem
Feature: Interview questions for black box testing – page_2 containt expected answers

Scenario Outline: Verify question and answer
 Given user is on the practicalsqa.net homepage
 And user click link "Interview questions for black box testing – page"
 And user clicking on the question "<Title>" from test case "<TestCaseID>"
 Then verify that answer "<TestCaseID>" containt "<Expected_result>"
 
 Examples:
|TestCaseID |Title                                          								|Expected_result  																						     |
|1			|Why do you want to be a QA engineer? Why QA?   								|t believe that there is only one good answer for this question, yet through the infinite         |
